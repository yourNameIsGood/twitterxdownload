            ...
            <div className="mx-auto py-8">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="space-y-8">
                        <section>
                            <p className="mb-4">
                                At TwitterMarketingBlog, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service to download videos and media content from Twitter (now X).
                            </p>
                            
                            <p className="mb-6">
                                By using TwitterMarketingBlog, you agree to the collection and use of information in accordance with this policy.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-semibold mb-4">Information We Collect</h2>
                            <p className="mb-4">We collect minimal information to provide and improve our service:</p>
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                <li><strong>Usage Data:</strong> We collect information about how you use our service, including the URLs you input for downloading, the time and date of your requests, and your IP address.</li>
                                ...
                                <li><strong>Cookies:</strong> We use cookies to improve your experience and analyze how our service is used.</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We do not store the content you download. All processing is done in real-time, and we do not keep copies of the videos or media you download.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We may employ third-party companies and individuals to facilitate our service, provide service-related services, or assist us in analyzing how our service is used. These third parties have access to your information only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.
                            </p>
                        </section>
